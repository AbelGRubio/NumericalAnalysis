"""
    Este modulo define el proceso iteratio de Gauss-Seidel para la resulucion de
...
def GaussSeidelIterative(*argvs, TOL: float = 1e-9, N: int = 500) -> list:
    """
    ...
    while k < N:
        # @@@@@@@@@@@@@@@@@@@@@@@@@@ STEP 3 @@@@@@@@@@@@@@@@@@
        for i in range(n):
            x[i] = 1 / A[i, i] * (-sum(A[i, range(i)] * x[range(i)]) -
